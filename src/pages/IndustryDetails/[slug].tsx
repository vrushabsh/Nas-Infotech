...
export default function IndustryDetails() {
  ...
  // Reset scroll position to top whenever the active industry changes
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [id]);
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-0">
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link 
                to="/contact" 
                className="px-6 py-3.5 bg-[#113217] hover:bg-[#113217]/90 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition-all shadow-sm flex items-center gap-2"
              >
                Discover More <ArrowUpRight className="w-4 h-4" />
              </Link>
              <Link 
                to="/contact"
                className="px-6 py-3.5 bg-white hover:bg-stone-50 text-stone-800 border border-stone-200 rounded-xl text-xs font-bold uppercase tracking-wider transition-all inline-block"
              >
                Get In Touch
              </Link>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 pb-16">
        <div className="w-full rounded-[2.5rem] bg-gradient-to-r from-slate-950 to-slate-900 p-10 sm:p-14 text-center space-y-6 relative overflow-hidden border border-slate-800 shadow-2xl">
          ...
          <div className="pt-4 relative z-10">
            <Link 
              to="/contact"
              className="px-8 py-4 bg-[#FFB057] hover:bg-[#f5a13f] text-[#111827] font-bold text-xs uppercase tracking-wider rounded-full transition-all duration-300 inline-block shadow-lg hover:scale-105"
            >
              {industry.ctaButton || "Discover More"}
            </Link>
          </div>
        </div>
      </section>
