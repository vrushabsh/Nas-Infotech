  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer:
        "We evaluate your current technical debt, database structures, security protocols, and scalability barriers. Our engineering architects then design a step-by-step phased migration matrix tailored to your budget.",
    },
    {
      id: 2,
      question: "2. What custom software development stacks do you support?",
      answer:
        "We specialize in enterprise systems using modern technologies including cloud-native Node.js/Go frameworks, robust React ecosystems, cloud infra toolings (AWS/GCP), and specialized Salesforce, Big Data, or AI/ML pipelines.",
    },
    {
      id: 3,
      question: "3. Can we scale or modify system requirements mid-sprint?",
      answer:
        "Yes, our development workflows are grounded in strict Agile principles. You can reprioritize project backlogs, adjust user stories, or safely refactor architecture roadmaps directly via our sprint review touchpoints.",
    },
    {
      id: 4,
      question:
        "4. Do you engineer custom software for enterprise scale businesses?",
      answer:
        "Absolutely. We engineer high-availability, high-throughput digital systems equipped with multi-region failover configurations and automated CI/CD pipelines to ensure continuous performance under heavy enterprise data loads.",
    },
    {
      id: 5,
      question:
        "5. What is your typical deployment turnaround and SLA response time?",
      answer:
        "Our automated cloud engineering pipelines allow code modifications to deploy safely in minutes. For mission-critical support, we back our systems with 24/7/365 monitoring and guaranteed response times under strict SLAs.",
    },
  ];
    ...
    <section className="py-20 bg-white font-sans text-[#0A1B10]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-8">
          ...
          <DynamicBadge title={"Frequently Asked Questions"} />

          {/* Heading */}
          {/* <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight leading-[1.1] text-[#0A1B10]">
          ...
          <h2 className="text-[#0a1118] text-3xl sm:text-5xl md:text-5xl font-bold leading-[1.15] tracking-tight">
            Common
            <span className="text-[#FFB057]"> Questions </span>
            about our<span className="text-[#FFB057]"> Tech Solutions </span>&
            Services<span className="text-[#FFB057]">.</span>
          </h2>

          {/* Description Paragraph */}
          <p className="text-slate-500 text-sm sm:text-base font-medium leading-relaxed max-w-md">
            We have answered the most common architectural and workflow
            questions to make onboarding our engineering teams simple and
            transparent.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-bold text-[#0A1B10] leading-snug">
            <div className="flex items-start gap-2.5">
              ...
              <span>
                Our dedicated DevOps team is always ready to monitor
                infrastructure
              </span>
            </div>
            <div className="flex items-start gap-2.5">
              <CheckCircle2 className="w-4 h-4 text-[#0D2A17] shrink-0 mt-0.5" />
              <span>
                We abstract away complex cloud logic so you can focus on core
                business
              </span>
            </div>
          </div>
